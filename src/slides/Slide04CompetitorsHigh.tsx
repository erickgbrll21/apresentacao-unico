...
export const Slide04CompetitorsHigh: React.FC = () => (
  <AbsoluteFill
    style={{
  ...
  >
    ...
    >
      ...
      <p style={{ margin: "0 0 12px", fontSize: 17, fontWeight: 500, color: theme.textMuted, lineHeight: 1.45, flexShrink: 0 }}>
        Quem atende o setor público em capacitação e benefício educacional — e onde a Unico Skill tem vantagem real.
      </p>
      <div
        style={{
          display: "flex",
      ...
      >
        {COMPETITORS_HIGH.map((c, i) => (
          <CompetitorCard key={c.name} {...c} index={i} compact descriptionSize={15} tagBackground="#F0EEE9" />
        ))}
      </div>
    </div>
  </AbsoluteFill>
